...
describe('Should test at a functional level ', () => {
    ...
    it('Should create an transaction', () => {
        ...
        cy.get(loc.EXTRATO.BUSCA_ELEMENTOS).should('exist')// vaidando se o nome com valor existe
    })
    it('Should get balance', () =>  {
        cy.get(loc.MENU.HOME).click()
        cy.get(loc.SALDO.SALDO_CONTA).should('contain',  '534,00')
    })
